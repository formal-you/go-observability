...
本组收纳仓库的 GitOps 治理文档：从分支命名、Issue/PR 记录与归档，到远程实操、发布清单与总流程。开发任务的具体执行剧本不在这里，见 [开发流程体系](../dev-sop/README.md)。
...
| 文档 | 负责 | 不负责 |
| --- | --- | --- |
| [开发流程体系](../dev-sop/README.md) | 任务执行剧本：需求收敛、多 Agent 编排、契约先行、验证、DoD | Issue/PR/合并/授权语义 |
